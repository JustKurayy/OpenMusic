            ...
            <aside className="w-16 lg:w-80 popofffront rounded-lg flex flex-col">
                ...
                <div className="mt-8 flex-1 flex flex-col">
                    <div className="px-3 lg:px-6">
                        <Link href="/library">
                            <a className="flex items-center justify-between w-full py-3 px-3 rounded-lg text-gray-300 hover:text-white hover:bg-gray-900 transition-all duration-200 group">
