                    ...
                    <div className="animate-pulse">
                        ...
                        <div className="space-y-3">
                            {[...Array(6)].map((_, i) => (
                                <div
                                    key={i}
                                    className="h-16 bg-spotify-light-gray/20 rounded"
                                ></div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="text-center py-20">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-400 text-lg mb-8 max-w-md mx-auto">
                                Upload your favorite tracks and create playlists
                                                    ...
                                                    (playlist) => (
                                                        <div className="group cursor-pointer">
                                                            <div className="relative bg-gray-900 bg-opacity-40 hover:bg-opacity-60 rounded-lg p-4 transition-all duration-200 hover:scale-105">
                                                                ...
                                                                <h3 className="font-bold text-white text-base mb-2 truncate group-hover:text-green-400 transition-colors duration-200">
                                                                    {
                                                                        playlist.name
                                                                    }
                                                                </h3>
                                            ...
                                            <div className="space-y-2">
                                                {filteredPlaylists.map(
                                                    (playlist) => (
                                                        <div
                                                            key={playlist.id}
                                                            className="flex items-center space-x-4 p-2 rounded-lg hover:bg-gray-800 hover:bg-opacity-60 group cursor-pointer transition-all duration-200"
                                                        >
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                <p className="font-semibold text-white truncate group-hover:text-green-400 transition-colors duration-200">
                                                                    {
                                                                        playlist.name
                                                                    }
                                                                </p>
                            ...
                            {shouldShowTracks && filteredTracks.length > 0 && (
                                <section>
                                  ...
                                  />
                                                            ...
                                                            <h3 className="font-bold text-white text-base mb-1 truncate group-hover:text-green-400 transition-colors duration-200">
                                                                {track.title}
                                                            </h3>
                                                            <p className="text-gray-400 text-sm truncate">
                                                                {track.artist}
